	...
	public class D2dDragToShoot : MonoBehaviour
	{
		...
		protected virtual void Update()
		{
			...
			if (Input.GetKey(Requires) == false && down == true)
			{
				...
				if (ImpactPrefab != null)
				{
					...
					if (mainCamera != null)
					{
						...
						var startPos = D2dHelper.ScreenToWorldPosition( startMousePosition);
						var endPos   = D2dHelper.ScreenToWorldPosition(Input.mousePosition);
			...
			if (down == true && mainCamera != null && IndicatorPrefab != null)
			{
				...
				var startPos = D2dHelper.ScreenToWorldPosition( startMousePosition);
				var endPos   = D2dHelper.ScreenToWorldPosition(Input.mousePosition); CalculateEndPos(startPos, ref endPos);
